  ...
  return (
    <div className="flex flex-wrap gap-3">
      ...
      <button
        ...
        className="flex items-center gap-2 bg-[#0077B5] text-white px-4 py-2 rounded-lg hover:bg-[#006399] transition-colors"
      ...
      <button
        ...
        className="flex items-center gap-2 bg-neutral-200 text-neutral-700 px-4 py-2 rounded-lg hover:bg-neutral-300 transition-colors"
